        ...
        <main class="flex-1 min-w-0">
            ...
            @if($parts->isEmpty())
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-16 text-center shadow-sm">
                    ...
                    <a href="https://wa.me/15125873425?text={{ urlencode('Hi, I need a part that is not listed on your website. Vehicle: ' . ($filters['make'] ?? '') . ' ' . ($filters['model'] ?? '') . ' ' . ($filters['year'] ?? '') . '. Part needed: ' . ($filters['q'] ?? '' ?? '' ?? '' ?? '' ?? '' ?? '' ?? '')) }}"
                       target="_blank"
                            ...
                            <div class="p-4 flex flex-col flex-1">
                                ...
                                <div class="mt-auto">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        ...
                                        <a href="https://wa.me/{{ str_contains($part->location, 'Nigeria') || str_contains($part->location,'Lagos') ? '2347064413764' : (str_contains($part->location,'Ghana') ? '2349155688804' : '15125873425') }}?text={{ $whatsappMsg }}"
                                           target="_blank"
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <div class="text-right flex-shrink-0">
                                        ...
                                        <div class="flex gap-2 mt-2">
                                            ...
                                            <a href="https://wa.me/15125873425?text={{ $whatsappMsg }}" target="_blank" class="text-xs font-body bg-green-500 text-white rounded-lg px-3 py-1.5 hover:bg-green-600 transition-colors">WhatsApp</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
