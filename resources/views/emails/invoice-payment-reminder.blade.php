{{-- FILE: resources/views/emails/invoice-payment-reminder.blade.php --}}
<!DOCTYPE html>
<html>
<body style="font-family: Arial, sans-serif; color: #222; max-width: 600px; margin: 0 auto;">
  ...
  <div style="border: 1px solid #e2e8f0; border-top: none; padding: 20px; border-radius: 0 0 8px 8px;">
    ...
    <p>This is a friendly reminder that your invoice <strong>{{ $invoice->invoice_no }}</strong> has an outstanding balance.</p>
