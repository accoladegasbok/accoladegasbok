{{-- FILE: resources/views/admin/customers/create-contact.blade.php --}}
...
<div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 space-y-4">
  <div>
    ...
    <input type="text" name="name" required class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-gold">
  </div>
  <div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
    <div>
      ...
      <input type="text" name="phone" required class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-gold">
    </div>
    <div>
...
<div class="flex gap-3 justify-end mt-5 pb-8">
  ...
  <button type="submit" class="bg-gold hover:bg-yellow-500 text-navy font-display font-700 text-sm px-8 py-3 rounded-xl transition-colors shadow-lg">Add Contact</button>
</div>
</form>
@endsection
