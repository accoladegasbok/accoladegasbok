    ...
    <div class="stat-card">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div class="border border-gray-200 rounded-xl p-4 sm:col-span-2">
          ...
          <p class="text-xs text-gray-400 font-body mb-3">Print, Email, and WhatsApp all send the single customer-facing copy — Invoices already cover full internal paperwork (Customer/Office/Accounts/Gate Pass) for anything needing that.</p>
