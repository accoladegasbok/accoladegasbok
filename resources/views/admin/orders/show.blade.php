    ...
    <div class="stat-card">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div class="border border-gray-200 rounded-xl p-4 sm:col-span-2">
          ...
          <p class="text-xs text-gray-400 font-body mb-3">Print now opens the full unified invoice template (Customer/Warehouse/Accounts/Gate Pass/Waybill copies, discount display, payment status) — same document manual invoices and car sale receipts already use. Email and WhatsApp still send the single customer-facing copy.</p>
          <div class="grid grid-cols-3 gap-2">
            <a href="{{ route('admin.invoices.show', $order->id) }}" target="_blank"
              ...
              <span class="text-xs font-body text-gray-600">Print</span>
            </a>
